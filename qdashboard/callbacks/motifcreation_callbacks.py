...
motif_button_default = html.Div([
    html.P('Select species and sequence from the data table'),
    html.P('and hit submit to create a motif')
], style={'padding': '10%', "color": "gray", "fontSize": "14px", "textAlign": "left"})
