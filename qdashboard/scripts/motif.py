...
class motif():
    ...
    def logo(self):
        """ needs package logomaker from https://github.com/jbkinney/logomaker
        """   
        bits_df = pd.DataFrame(self.bits)
        self.styling()
        figsize = (4.17,1.08 )
        
        m_logo = logomaker.Logo(bits_df,
...
# # make motif from seqs   
# m = motif(seqs)

# # make logo from seqs
# logo = m.logo()
# # plt.figtext(0.91, 0.91, specs, fontsize=14)
# plt.show()
